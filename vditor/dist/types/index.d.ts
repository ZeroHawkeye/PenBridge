...
interface ILuteRender {
    ...
    renderAlignDirective?: ILuteRenderCallback;
    renderAlignDirectiveOpenMarker?: ILuteRenderCallback;
    renderAlignDirectiveCloseMarker?: ILuteRenderCallback;
}
...
declare class Lute {
    ...
    public SetAlignDirective(enable: boolean): void;
...
interface IMarkdownConfig {
    ...
    /** 支持下标 */
    sub?: boolean;
    /** 支持对齐指令 (:::center, :::left, :::right, :::justify) */
    alignDirective?: boolean;
}
